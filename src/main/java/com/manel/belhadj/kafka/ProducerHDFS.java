...
public class ProducerHDFS {

	private final static String PATH = "/user/admin/InputTSV/input.tsv";
	public static final String TOPIC_NAME = "SparkStreaming";
	public static final String HDFS_URI = "hdfs://manel-pc:8020";

	public static Properties Config() {

		Properties props = new Properties();
		props.put("bootstrap.servers", "manel-pc:6667");// "tcb1.server.hdp.com:6667,tcb2.server.hdp.com:6667,tcb4.server.hdp.com:6667,tcb3.server.hdp.com:6667");
		props.put("acks", "all");
		props.put("retries", 0);
	...
	public static Configuration HDFSConf() {
		...
		conf.set("fs.defaultFS", "hdfs://manel-pc:8020");
